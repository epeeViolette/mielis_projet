...
if (isset($_POST['ajouter'])) {
    ...
    $stmt = $lien->prepare('INSERT INTO miel (nom_miel,type_miel,provenance_miel,description_miel,image) values (:nom_miel,:type_miel,:provenance_miel,:description_miel,:image)');
