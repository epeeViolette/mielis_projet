...
if (isset($_POST['modifier'])) {
    ...
    $stmt = $lien->prepare('UPDATE miel SET nom_miel = :nom_miel,type_miel = :type_miel,provenance_miel = :provenance_miel,description_miel = :description_miel,image = :image,prix = :prix WHERE id_miel =:id_miel');
